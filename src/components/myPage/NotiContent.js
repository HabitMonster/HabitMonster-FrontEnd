    ...
    return (
      <NotiBox>
        <p>
          ...
          <br />
          오늘 하루 우리들은 습관대로 생각하고, 말하고 행동해왔을 겁니다. 이렇게
          습관은 항상 우리 곁에 있으며 우리의 정체성을 결정하며 삶의 방향에
          영향을 미칩니다. HabitMonster와 함께 좋은 습관을 생성하고 유지하는
          일상이 하루하루 쌓이다 보면 매일 성장하고 발전하는 여러분들을 보실 수
          있을 거라 확신합니다.
          <br />
          <br />
    ...
    return (
      <NotiBox>
        <p>
          ...
          <br />
          <br />
          저희 팀이 더 나은 서비스를 제공하기 위해 현재 피드백을 받고있지만
          피드백 작성이 손이 많이 가는 일인 것 같아요. 그래서 저희가 작은
          이벤트를 준비했습니다. <br />
          <br />
          피드백을 작성해주신 분들께 추첨을 통해 저희의 마음이 담긴 선물을
          드리려고해요! 참여방법은 아래 글을 참고해주세요. <br />
          참여방법 첫번째! <br />
          1. HabitMonster 페이지에서 서비스 이용 후 메인페이지의 “FeedBack”
          아이콘을 누른 후 구글 폼을 사용해 피드백을 제출한다. <br />
