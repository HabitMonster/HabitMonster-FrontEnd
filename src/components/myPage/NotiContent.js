  ...
  switch (id) {
    ...
    case 2:
      return (
        <NotiBox>
          ...
          <ol>
            <ListText>
              1. Habit Monster서비스 이용 후 메인페이지 좌측 상단의 “피드백”
    ...
    case 3:
      return (
        <NotiBox>
          <p>
            저희 Habit Monster는 PC에서의 웹 뿐만 아니라 스마트폰 모바일
            환경에서는 마치 앱처럼 사용하실 수 있도록 최적화하여 만든
            서비스입니다.
          </p>
          <p>
            스마트폰에서 웹 브라우저를 통해 사용하실 경우 다소 불편함을 느끼실
            수 있기 때문에 아래에 있는 모바일 환경에서의 추가 및 설치 방법을
            통해 서비스를 이용해주시면 더욱 편리하게 사용하실 수 있습니다.
          </p>
          <br />
          <ListNumbering>아이폰 Safari 💡</ListNumbering>
          <ol>
            <ListText>
              1. Safari에 접속한 후 검색창에 <b>habitmonster.app</b> 을
              입력해주세요.
            </ListText>
            ...
            <ListText>
              5. 이제부터 앱으로 설치된 Habit Monster 서비스를 편하게 이용하실
              수 있습니다.
            </ListText>
          </ol>
          ...
          <ol>
            <ListText>
              1. Chrome에 접속한 후 검색창에 <b>habitmonster.app</b>을
              입력해주세요.
            </ListText>
            <ListText>2. 동그라미 표시를 눌러주세요.</ListText>
            <ListText>3. 홈 화면에 추가를 눌러주세요.</ListText>
            ...
            <ListText>
              7. 이제부터 앱으로 설치된 Habit Monster 서비스를 편하게 이용하실
              수 있습니다.
            </ListText>
          </ol>
